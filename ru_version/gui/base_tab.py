...
class BaseTab(ttk.Frame):
    ...
    def add_console_widget(self):
        ...
        tk.Button(ctrl_frame, text="Копировать", font=("Arial", 8), 
                 command=self.copy_console).pack(side="right")
        
        tk.Button(ctrl_frame, text="Очистить", font=("Arial", 8), 
                 command=self.clear_console).pack(side="right", padx=5)

        tk.Label(ctrl_frame, text="Лог операций:", font=("Arial", 9, "bold")).pack(side="left")
